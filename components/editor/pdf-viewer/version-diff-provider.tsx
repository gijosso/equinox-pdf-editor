    ...
    const calculateDiffs = async () => {
      try {
        ...
        annotations2.forEach(ann2 => {
          ...
          if (!found) {
            calculatedAnnotationDiffs.push({id: ann2.id, type: "added", annotation: ann2})
          } else if (areAnnotationsDifferent(found, ann2)) {
            calculatedAnnotationDiffs.push({id: ann2.id, type: "modified", annotation: ann2, oldAnnotation: found})
          } else {
        ...
        annotations1.forEach(ann1 => {
          ...
          if (!found) {
            calculatedAnnotationDiffs.push({id: ann1.id, type: "removed", annotation: ann1})
          }
        })
